...
class _TelaRelatorioSemaforosState extends State<TelaRelatorioSemaforos> {
  ...
  Future<void> _carregarDados() async {
    try {
      ...
      for (var doc in snapshot.docs) {
        ...
        // Alimentar os Sets para o Autocomplete (ignorando nulos e formatando maiúsculo)
  ...
  bool _passouNoFiltro(Map<String, dynamic> item) {
    ...
    if (!matchString(item['numero_formatado'], _fNumero.text)) return false;
    ...
    if (!matchString(item['tipo_do_controlador'], _fControlador.text)) return false;
  ...
  Widget build(BuildContext context) {
    ...
    if (_paginaAtual >= totalPaginas && totalPaginas > 0) {
      _paginaAtual = totalPaginas - 1; // Ajuste de segurança
    }
                        ...
                        if (_mostrarFiltros) ...[
                          Container(
                            ...
                            child: SingleChildScrollView(
                              padding: const EdgeInsets.all(16),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.stretch, // Estica para alinhar ao centro
                                children: [
                                    ...
                                    children: _filtrosBooleanos.map((f) => SizedBox(
                                      ...
                                      child: CheckboxListTile(
                                        ...
                                        onChanged: (v) {
                                          setState(() {
                                            f.ativo = v!;
                                            _paginaAtual = 0; // Volta pra página 1 ao filtrar
                                          });
                                        },
                                      ),
                                    )).toList(),
  ...
  // Helper de Interface: Agora transformado em Autocomplete!
  Widget _buildAutocompleteField(String label, TextEditingController controller, FocusNode focus, List<String> options) {
    return SizedBox(
      width: 180,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.center, // Centraliza os textos do form
        children: [
          ...
          Container(
            ...
            child: RawAutocomplete<String>(
              ...
              onSelected: (String selection) {
                ...
                setState(() {
                  _paginaAtual = 0; // Volta para a primeira página ao alterar um filtro
                });
              },
              fieldViewBuilder: (BuildContext context, TextEditingController textEditingController, FocusNode focusNode, VoidCallback onFieldSubmitted) {
                return TextField(
                  ...
                  textAlign: TextAlign.center, // Texto digitado centralizado
